 ...
 * @author gustavo
 */
public class TelaResultadoBusca extends javax.swing.JDialog {

    /**
     * Creates new form AddNode
     */
    public TelaResultadoBusca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaResultadoBusca dialog = new TelaResultadoBusca(new javax.swing.JFrame(), true);
